...
const WorkImage: React.FC<WorkImageProps> = ({ imageUrl, title }) => {
    return (
        <Image
            loader={() => imageUrl}
            width="400"
...
const DescriptionDiv: React.FC<DescriptionDivProps> = ({ description }) => {
    return (
        <div>
...
const WorkCard: React.FC<WorkCardProps> = ({ workData }) => {
    ...
    return (
        <LinkOrSpanFromClickUrl clickUrl={click_url} title={work_name}>
            <WorkImage imageUrl={image_url} title={work_name} />
...
export const WorkCardDiv: React.FC<WorkCardDivProps> = ({ worksData }) => {
    return (
